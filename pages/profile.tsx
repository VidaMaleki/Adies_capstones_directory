            ...
            <div className="w-2 flex justify-between px-8 py-8">
                <div>
                    <button
                        ...
                        className="absolute top-0 left-0 mt-2 mr-2 text-gray-500 pt-4 pl-4 flex gap-2"
                        >
                ...
                <div>
                    <button
                        className="absolute top-0 right-0 mt-2 mr-2 text-gray-500 pt-4 pr-4 flex gap-2"
